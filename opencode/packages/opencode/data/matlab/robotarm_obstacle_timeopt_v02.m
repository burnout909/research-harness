...
% Experiment: robotarm_obstacle_timeopt_v02
% Date: 2026-02-28
% Objective: Find time-optimal trajectory avoiding obstacle with torque constraints (Increased Torque Limit)
...
% Constraints
tau_max = 20.0;      % N.m (Input constraint INCREASED)
vel_max = 3.0;       % rad/s
...
% Simulation Settings
dt = 0.01;
max_iter_rrt = 5000; % Increased from 2000 to improve success rate
...
%% 4. Save & Visualize
results = struct();
results.experiment = 'robotarm_obstacle_timeopt_v02';
results.T_opt = T_opt;
...
mat_file = fullfile(script_dir, 'robotarm_obstacle_timeopt_v02_result.mat');
fig_file = fullfile(output_dir, 'robotarm_obstacle_timeopt_v02_plot.png');
