      ...
      <div className="px-2 py-1">
        <div
          ...
          className={`
            ...
            px-2.5 py-1.5 cursor-pointer transition-all text-xs
            ${isDragging
        ...
        >
          {isUploading ? (
            ...
            <svg className="flex-shrink-0" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          <span className="truncate">
            {isUploading ? progress : (
              <>
                ...
                <span className="text-zinc-600 ml-1">xlsx, csv, pdf, docx...</span>
              </>
            )}
          </span>
          <input
        ...
        {progress && !isUploading && (
          <div className="mt-1 text-xs text-green-400 px-1">{progress}</div>
        )}
      </div>
    );
  }
